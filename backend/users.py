...
class UserGenericHandler(GenericWebHandler):
        ...
        def get(self):
                ...
                template_variables = {'user':self.screen_name, 'avatar':self.avatar,'instaright_account':self.instaright_account,'facebook_profile': self.facebook_profile, 'twitter_profile': self.twitter_profile, 'google_profile': self.google_profile, 'flickr_profile': self.flickr_name, 'evernote_profile': self.evernote_name, 'links':links, 'score': score, 'visible_items_num': self.visible_links, 'badges': badges,'logout_url':'/account/logout'}
